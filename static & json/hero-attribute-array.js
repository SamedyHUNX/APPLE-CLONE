...
const heroImgAttributeArray = [
  [
    ["src", "./assets/images/IPhone/hero-ip15-new.jpg"],
    ["alt", "iPhone 15 Pro"],
    [
      "src",
  ...
  [
    ["src", "./assets/images/Promo/Vision Pro/apple-vision-pro.jpg"],
    ["alt", "Apple Vision Pro"],
    ["src", "./assets/images/Promo/Vision Pro/apple-vision-pro-small.jpg"],
  ],
  [
    [
      "src",
  ...
  [
    ["src", "./assets/images/Promo/Ipad/promo_ipad__fioegapg12qi_small_2x.jpg"],
    ["alt", "iPad"],
    ["src", "./assets/images/Promo/Ipad/promo_ipad__fioegapg12qi_small_2x.jpg"],
  ],
  [
    ["src", "./assets/images/Promo/Card/tile__cauwwcyyn9hy_large_2x.jpg"],
    ["alt", "iCard"],
    ["src", "./assets/images/Promo/Card/tile__cauwwcyyn9hy_small_2x.jpg"],
  ],
  [
    [
      "src",
